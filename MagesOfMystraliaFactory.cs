...
{
    public class MagesOfMystraliaFactory : IComponentFactory
    {
        private MagesOfMystraliaComponent _instance;
        ...
        {
            get { return "Automates load removal for Mages Of Mystralia."; }
        }
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            if (_instance != null && !_instance.Disposed)
            {
                ...
                MessageBox.Show(
                    "LiveSplit.MagesOfMystralia is already loaded in the " +
            ...
            return (_instance = new MagesOfMystraliaComponent(state, createAsLayoutComponent));
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/SuiMachine/LiveSplit.MagesOfMystralia/master/"; }
        }
        ...
        {
            get { return this.UpdateURL + "Components/update.LiveSplit.MagesOfMystralia.xml"; }
        }
    }
